...
# GRPO Test Script for Qwen2.5-1.5B on DeepMath-103K
# Use this to verify installation before running RAPO
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='qwen1_5b_grpo_deepmath103k_test' \
