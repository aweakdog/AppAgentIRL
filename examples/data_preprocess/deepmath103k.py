...
"""
Preprocess the DeepMath-103K dataset to parquet format for RAPO training
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--local_save_dir", default="~/data/deepmath103k", help="The save directory for the preprocessed dataset."
    )
    ...
    # DeepMath-103K only has train split
    train_dataset = dataset["train"]
    
    # Split into train and test (95% train, 5% test)
    ...
    def make_map_fn(split):
        def process_fn(example, idx):
            # DeepMath-103K has 'problem' and 'answer' fields
